class ConNoPricePdf < Prawn::Document
  def initialize()
    super(top_margin: 70)
  ...
  def line_item_rows1
    ...
    [["Image", "Title", "SKU","QTY" ,"Description"],
     [{:image => image_path1}, "Basins 1", "ITA005", "x2", "This is a Basins"],[{:image => image_path3}, "Toilets", "ITA0014","x3", "This is a Toilet"],
     [{:image => image_path4}, "Tile 2", "ITA002","x2", "This is a tile"],[{:image => image_path2}, "Acc", "ITA005","x1", "This is a wall unit"], [{:image => image_path5}, "Tile 1", "ITA001", "x1","This is a tile"]
    ]
